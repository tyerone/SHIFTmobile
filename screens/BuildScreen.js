...
function BuildCard({ title, location, image }) {
  return (
    <Pressable style={styles.card} onPress={() => {}}>
      ...
      <Text 
        style={styles.cardTitle} numberOfLines={1}>{title}
      </Text>
      <Text 
        style={styles.cardMeta} numberOfLines={1}>{location}
      </Text>
    </Pressable>
  );
}
...
export default function BuildScreen() {
  const saved = useMemo(
    () => [
      { id: 's1', title: 'Red Bull RB21', location: 'Richmond Lordco, BC', image: null },
      { id: 's2', title: 'Mercedes CLS63', location: 'Richmond Lordco, BC', image: null },
  ...
  const inProgress = useMemo(
    () => [
      { id: 'p1', title: 'RB21 Widebody', location: 'Richmond Lordco, BC', image: null },
      { id: 'p2', title: 'CLS63 Wheels', location: 'Richmond Lordco, BC', image: null },
      { id: 'p3', title: 'GR86 Exhaust', location: 'Richmond, BC', image: null },
    ],
    []
  );
  ...
  const completed = useMemo(
    () => [
      { id: 'c1', title: 'RB21 Wrap', location: 'Richmond Lordco, BC', image: null },
      { id: 'c2', title: 'CLS63 Tune', location: 'Richmond Lordco, BC', image: null },
